...
inline void select_bank_it(alt_u8 bank) {
	cur_bank = bank;
	I2C_start(I2CA_HDMI_BASE, IT_BASE, 0);
	I2C_write(I2CA_HDMI_BASE, IT_CURBANK, 0);
	I2C_write(I2CA_HDMI_BASE, cur_bank, 1);
}
...
inline alt_u32 read_it(alt_u32 regaddr) {
	...
	I2C_start(I2CA_HDMI_BASE, IT_BASE, 0);
	I2C_write(I2CA_HDMI_BASE, (regaddr & 0xFF), 0);
	I2C_start(I2CA_HDMI_BASE, IT_BASE, 1);
	return I2C_read(I2CA_HDMI_BASE,1);
}
...
inline void write_it(alt_u32 regaddr, alt_u8 data) {
	...
	I2C_start(I2CA_HDMI_BASE, IT_BASE, 0);
	I2C_write(I2CA_HDMI_BASE, (regaddr & 0xFF), 0);
	I2C_write(I2CA_HDMI_BASE, data, 1);
}
